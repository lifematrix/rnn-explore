"""
A simple program to implement a rnn network to echo input character.
Using rnn cells.
"""
...
cell = [tf.nn.rnn_cell.DropoutWrapper(tf.nn.rnn_cell.LSTMCell(state_size, state_is_tuple=True), output_keep_prob=0.5) \
...
predictions_series = [tf.nn.softmax(logit_) for logit_ in logits_series]
